...
async function goToTransformationEntry(id,index=0){
  closePokemonModal();
  ...
  requestAnimationFrame(()=>{
    const card=document.querySelector(`#dexResults .poke-card[data-id="${id}"][data-special-category="transform"][data-special-index="${index}"]`)
      ||document.querySelector(`#dexResults .poke-card[data-id="${id}"][data-special-category="transform"]`);
    if(card){
